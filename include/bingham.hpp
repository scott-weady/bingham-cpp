...
public:
    ...
    int N; //grid size
    int Ncheb; //number of Chebyshev modes
    double zeta; //alignment parameter

    // Constructor
    BinghamClosure(int Ncheb, int N, double zeta) : Ncheb(Ncheb), N(N), zeta(zeta){
    ...
    auto compute(tensor::Tensor2 Q, tensor::Tensor2 Du){
